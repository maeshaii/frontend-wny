            ...
            <div className="profile-bio-container">
              ...
              {user?.profile_resume ? (
                <div className="profile-resume-wrapper">
                  ...
                  {isOwnProfile ? (
                    <button onClick={handleDeleteResume} className="profile-resume-delete-btn">
                      Delete Resume
                    </button>
                  ) : null}
                </div>
                ...
                <>
                  ...
                  <button onClick={handleSaveResume} className="profile-resume-upload-btn">
                    Upload Resume
                  </button>
                </>
              ) : null}
                          ...
                          <img
                            src={
                              follower.profile_pic
                                ? `http://127.0.0.1:8000${follower.profile_pic}`
                                : ctulogo
                            }
                            alt={follower.name}
        ...
        <div className="profile-center-content">
          ...
          <div className="profile-social-post-card">
            ...
            <div className="profile-post-header">
              ...
              />
              <div>
                <div className="profile-post-user-name">{user?.name || 'ok'}</div>
            ...
            <div className="profile-post-content">
              ...
              Ut neque ipsam sed explicabo nemo ut sapiente consectetur qui omnis ducimus qui
              voluptatem iusto? Id enim quia quo quam consequatur sit nulla delectus aut accusamus
              velit est animi sint eos consequatur nemo sit facilis ipsam. Est dolores tenetur in
              dignissimos velit At rerum minus qui velit autern qui officia sint!
            </div>
